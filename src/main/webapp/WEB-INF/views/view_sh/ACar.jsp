...
<div id="result0">
	...
	<div class="listBottom">
	    ...
	    <c:if test="${page.startPage > page.pageBlock}">
	        <a id="page" href="${pageContext.request.contextPath}/getListSearch?currentPage=${page.startPage-page.pageBlock}&total=${total}&keyword=${keyword}">&nbsp; 이전 &nbsp;</a>
	    </c:if>
	
	    <!-- 페이징 번호 표시 -->
	    <c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
	        <a id="page" href="${pageContext.request.contextPath}/getListSearch?currentPage=${i}&total=${total}&keyword=${keyword}">&nbsp; ${i} &nbsp;</a>
	    </c:forEach>
	
	    <!-- 다음 페이지로 이동 -->
	    <c:if test="${page.endPage < page.totalPage}">
	        <a id="page" href="${pageContext.request.contextPath}/getListSearch?currentPage=${page.startPage+page.pageBlock}&total=${total}&keyword=${keyword}">&nbsp; 다음 &nbsp;</a>
	    </c:if>
	</div>
