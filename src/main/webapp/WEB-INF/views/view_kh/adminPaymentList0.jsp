...
<body>
	...
	<div id="searchDiv">
		<form action="/KH/pay/paymentList">
			<input	type="text"		name="user_id"		id="user_id"		value="${user_id }" placeholder="user_id"/>
	...
	<div id="paymentListDiv">
		...
		<table id="paymentListTable">
			<tr>
				<th class="paymentListCell" style="width: 35px;">구분</th>
				<th class="paymentListCell" style="width: 190px;">승인번호</th>
				<th class="paymentListCell" style="width: 90px;">결제일시</th>
				<th class="paymentListCell" style="width: 115px;">차량매물번호</th>
				<th class="paymentListCell" style="width: 115px;">전문가리뷰번호</th>
				<th class="paymentListCell" style="width: 105px;">결제금액</th>
				<th class="paymentListCell" style="width: 145px;">취소승인번호발송</th>
		...
		<div id="pagingDiv">
			<div id="paging">
				<c:if test="${page.startPage > page.pageBlock }">
					<a href="/KH/pay/paymentList?currentPage=${page.startPage - page.pageBlock }&user_id=${user_id}&admin_id=${admin_id}">[Previous]</a>
				</c:if>
				
				<c:forEach var="i" begin="${page.startPage }" end="${page.endPage}">
					<a href="/KH/pay/paymentList?currentPage=${i }&user_id=${user_id}&admin_id=${admin_id}">[${i }]</a>
				</c:forEach>
				
				<c:if test="${page.startPage < page.pageBlock }">
					<a href="/KH/pay/paymentList?currentPage=${page.startPage + page.pageBlock }&user_id=${user_id}&admin_id=${admin_id}">[Next]</a>
				</c:if>
			</div>
		</div>
